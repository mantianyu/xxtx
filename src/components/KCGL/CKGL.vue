  ...
  <el-container style="height: 100%;background: #ffffff;">
        ...
        <div class="top-tit">
            ...
            <div class="find">
                <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="出库时间" prop="startDate" label-width="100px">
    ...
    <el-main style="position: relative;">
      <el-scrollbar class="scrollbar" style="width: 100%;height: 100%;overflow-x: hidden;position: absolute;left: 0;top: 0;">
        <v-ckglt :searchData="searchData" :repo="repo" :operator="operator"></v-ckglt>
      </el-scrollbar>
    </el-main>
  </el-container>
</template>
...
<script>
import VCkglt from "./common/CKGLTable.vue";
...
export default {
  ...
  methods: {
    ...
    fetchOutComekv: async function() {
      let url = this.api.getoutcomekv;
      let data = {};
