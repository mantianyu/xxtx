<template>
        ...
        <el-table-column
          label="操作">
            <template slot-scope="scope">
                <el-button type="text" size="small" @click="showCheckOut(scope.row)">出院登记</el-button>
            </template>
        </el-table-column>
		</el-table>
    ...
    <v-etzdj :oldCheckOutId="oldCheckOutId" :checkOut="checkOut" :isEdit="false"></v-etzdj>
	</div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    fetchList: async function(val) {
      this.loading = true;
      let url = this.api.eldercheckoutregisterlist + "?page=" + val;
