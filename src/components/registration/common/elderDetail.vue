      ...
      <el-header style="height: auto;">
        <div class="pop-top">
          ...
          <div style="position: absolute;display: flex;left: 140px;top: 10px;">
            ...
            <div :class="{'pop-title':true, 'poptitlebg': isYYGL}" @click="showYYGL">用药管理</div>
            <div :class="{'pop-title':true, 'poptitlebg': isFYGL}" @click="showFYGL">费用管理</div>
          </div>
        ...
        <el-scrollbar class="scrollbar" style="width: 100%;height: 91%;overflow-x: hidden;position: absolute;left: 0;top: 0;margin-top: 50px;">
          <div class="qxz">
            <v-info
              ...
              :elderId="elderId"
              :elderBed="elderBed"
              :checkin_id="checkin_id"></v-drug>
              <v-price
              v-if="isFYGL"
              :elderId="elderId"
              :imprests="imprests"
              :deposits="deposits"
              :checkin_id="checkin_id"></v-price>
          </div>
        </el-scrollbar>
      </el-main>
    </el-container>
...
import vDrug from "./elderDrug.vue";
import vPrice from "./elderPrice.vue";
