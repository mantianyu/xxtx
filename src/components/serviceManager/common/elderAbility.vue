		...
		<el-form ref="form" :model="form" label-width="150px">
			<el-tabs type="border-card" v-model="activeName">
			  	...
			  	<el-tab-pane label="社会参与" name="6" disabled>
		            ...
		            <div class="login-btn" style="margin-top: 20px;display: flex;align-items:center;justify-content:center;border-top: 1px #E5E5E5 solid;padding-top: 28px;">
		            	<el-button type="info" size="medium" @click="handleBtnPrev(6)">上一步</el-button>
		                <el-button v-if="!main" type="danger" size="medium" :loading="bLoading" style="margin-left: 30px;" @click="submitForm('form')">查看评估结果</el-button>
		            </div>
			  	</el-tab-pane>
			</el-tabs>
		</el-form>
...
<script>
export default {
  props: ["elderDetail", "elderid", "hid", "main"],
  data() {
    return {
      form: {
        dementia_score: "",
  ...
  mounted() {
    if (this.elderDetail.length !== 0) {
      this.form.dementia_score = this.elderDetail.dementia_score !== '' ? this.elderDetail.dementia_score : "";
      this.form.mental_disease_score = this.elderDetail.mental_disease_score !== '' ? this.elderDetail.mental_disease_score : "";
      this.form.fall_down_score = this.elderDetail.fall_down_score !== '' ? this.elderDetail.fall_down_score : "";
      this.form.get_lost_score = this.elderDetail.get_lost_score !== '' ? this.elderDetail.get_lost_score : "";
      this.form.choke_score = this.elderDetail.choke_score !== '' ? this.elderDetail.choke_score : "";
      this.form.suicide_score = this.elderDetail.suicide_score !== '' ? this.elderDetail.suicide_score : "";
      this.form.eat_score = this.elderDetail.eat_score !== '' ? this.elderDetail.eat_score : "";
      this.form.bathe_score = this.elderDetail.bathe_score !== '' ? this.elderDetail.bathe_score : "";
      this.form.dress_up_score = this.elderDetail.dress_up_score !== '' ? this.elderDetail.dress_up_score : "";
      this.form.dress_score = this.elderDetail.dress_score !== '' ? this.elderDetail.dress_score : "";
      this.form.stool_control_score = this.elderDetail.stool_control_score !== '' ? this.elderDetail.stool_control_score : "";
      this.form.urination_control_score = this.elderDetail.urination_control_score !== '' ? this.elderDetail.urination_control_score : "";
      this.form.go_to_bathroom_score = this.elderDetail.go_to_bathroom_score !== '' ? this.elderDetail.go_to_bathroom_score : "";
      this.form.move_bed_chair_score = this.elderDetail.move_bed_chair_score !== '' ? this.elderDetail.move_bed_chair_score : "";
      this.form.level_walking_score = this.elderDetail.level_walking_score !== '' ? this.elderDetail.level_walking_score : "";
      this.form.stair_activity_score = this.elderDetail.stair_activity_score !== '' ? this.elderDetail.stair_activity_score : "";
      this.form.daily_living_activity_score = this.elderDetail.daily_living_activity_score !== '' ? this.elderDetail.daily_living_activity_score : "";
      this.form.daily_living_activity_grade_score = this.elderDetail.daily_living_activity_grade_score !== '' ? this.elderDetail.daily_living_activity_grade_score : "";
      this.form.cognitive_function_score = this.elderDetail.cognitive_function_score !== '' ? this.elderDetail.cognitive_function_score : "";
      this.form.aggressive_behavior_score = this.elderDetail.aggressive_behavior_score !== '' ? this.elderDetail.aggressive_behavior_score : "";
      this.form.depressive_symptoms_score = this.elderDetail.depressive_symptoms_score !== '' ? this.elderDetail.depressive_symptoms_score : "";
      this.form.mental_state_score = this.elderDetail.mental_state_score !== '' ? this.elderDetail.mental_state_score : "";
      this.form.mental_state_grade_score = this.elderDetail.mental_state_grade_score !== '' ? this.elderDetail.mental_state_grade_score : "";
      this.form.consciousness_level_score = this.elderDetail.consciousness_level_score !== '' ? this.elderDetail.consciousness_level_score : "";
      this.form.vision_score = this.elderDetail.vision_score !== '' ? this.elderDetail.vision_score : "";
      this.form.hearing_score = this.elderDetail.hearing_score !== '' ? this.elderDetail.hearing_score : "";
      this.form.communicate_score = this.elderDetail.communicate_score !== '' ? this.elderDetail.communicate_score : "";
      this.form.sensory_perception_communicate_grade_score = this.elderDetail.sensory_perception_communicate_grade_score !== '' ? this.elderDetail.sensory_perception_communicate_grade_score : "";
      this.form.viability_score = this.elderDetail.viability_score !== '' ? this.elderDetail.viability_score : "";
      this.form.working_ability_score = this.elderDetail.working_ability_score !== '' ? this.elderDetail.working_ability_score : "";
      this.form.space_time_cognition_score = this.elderDetail.space_time_cognition_score !== '' ? this.elderDetail.space_time_cognition_score : "";
      this.form.personnel_cognition_score = this.elderDetail.personnel_cognition_score !== '' ? this.elderDetail.personnel_cognition_score : "";
      this.form.social_communication_ability_score = this.elderDetail.social_communication_ability_score !== '' ? this.elderDetail.social_communication_ability_score : "";
      this.form.social_score = this.elderDetail.social_score !== '' ? this.elderDetail.social_score : "";
      this.form.social_grade_score = this.elderDetail.social_grade_score !== '' ? this.elderDetail.social_grade_score : "";
    }
  },
  methods: {
    submitForm(formName) {
        ...
        if (valid) {
          ...
          if (this.hid == 0) {
            var data = {
              ...
              daily_living_activity_score: this.form
                .daily_living_activity_score,
            ...
            this.$parent.$parent.$parent.$parent.saveAbility(data);
            this.bLoading = false;
          } else {
            var data = {
              hid: this.hid,
