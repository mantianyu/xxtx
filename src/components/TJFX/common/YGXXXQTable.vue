<template>
    <div class="lrxxxq">
        <el-table v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%">
            ...
            <el-table-column prop="org_name" label="所属机构" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="professional_level" label="职称级别" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="professional_title" label="职称" show-overflow-tooltip>
            </el-table-column>
...
export default {
  ...
  methods: {
    fetchList: async function(val) {
      this.loading = true;
      let url = this.api.employeelist + "?page=" + val;
    ...
    exportList: async function(){
      let url = this.api.exportemployeelist;
