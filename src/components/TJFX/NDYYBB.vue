        ...
        <div class="top-tit">
            ...
            <div class="find">
                <el-form label-width="400px" :rules="rules" ref="ruleForm" :model="ruleForm">
                    ...
                    <el-form-item label="年度筛选：" prop="year">
                        <el-date-picker type="year" size="small" placeholder="选择日期" style="width: 140px;" value-format="yyyy" v-model="ruleForm.year"></el-date-picker>
                    </el-form-item>
...
export default {
  ...
  methods: {
    ...
    fetchList: async function(val) {
      this.loading = true;
      let url = this.api.operationYearList + "?page=" + val;
    ...
    fetchChart: async function() {
      let url = this.api.operattionYearChart;
      let data = {
        year: this.balanceData.length !== 0 ? this.balanceData : 2018
      };
      const res = await this.$http.post(url, data);
      this.chartData = res.data.data;
    },
    exportList: async function() {
      let url = this.api.operationYearExport;
