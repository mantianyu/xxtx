  ...
  <el-container style="height: 100%;background: #ffffff;">
    <el-header style="min-height: 60px;height: auto;">
		<div class="top-tit">
			<h5>员工档案</h5>
			<div class="find">
				<el-form :model="ruleForm" size="small" :rules="rules" label-width="80px" ref="ruleForm" :inline="true">
    ...
    <el-main style="position: relative;">
      <el-scrollbar class="scrollbar" style="width: 100%;height: 100%;overflow-x: hidden;position: absolute;left: 0;top: 0;">
		<v-ygxxxqtb :searchData="searchData"></v-ygxxxqtb>
      </el-scrollbar>
    </el-main>
  </el-container>
</template>
...
<script>
import vYgxxxqtb from "./common/YGXXXQTable.vue";
